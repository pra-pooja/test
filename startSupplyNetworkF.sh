...
export ORDERER_CA=./organizations/ordererOrganizations/supplychain.com/orderers/orderer.supplychain.com/msp/tlscacerts/tlsca.supplychain.com-cert.pem

export ORDERER_ADMIN_TLS_SIGN_CERT=./organizations/ordererOrganizations/supplychain.com/orderers/orderer.supplychain.com/tls/server.crt

export ORDERER_ADMIN_TLS_PRIVATE_KEY=./organizations/ordererOrganizations/supplychain.com/orderers/orderer.supplychain.com/tls/server.key

echo "------ Osnadmin Join application channel------"

osnadmin channel join --channelID $CHANNEL_NAME --config-block ./channel-artifacts/$CHANNEL_NAME.block -o localhost:7053 --ca-file $ORDERER_CA --client-cert $ORDERER_ADMIN_TLS_SIGN_CERT --client-key $ORDERER_ADMIN_TLS_PRIVATE_KEY
sleep 2

echo "------ Osnadmin Channel list------"
osnadmin channel list -o localhost:7053 --ca-file $ORDERER_CA --client-cert $ORDERER_ADMIN_TLS_SIGN_CERT --client-key $ORDERER_ADMIN_TLS_PRIVATE_KEY
	
sleep 2

echo "—---------------Set up enviornment variable for Factory —-------------"
...
peer channel fetch config channel-artifacts/config_block.pb -o localhost:7050 --ordererTLSHostnameOverride orderer.supplychain.com -c $CHANNEL_NAME --tls --cafile $ORDERER_CA
sleep 1
...
peer channel update -f channel-artifacts/config_update_in_envelope.pb -c $CHANNEL_NAME -o localhost:7050  --ordererTLSHostnameOverride orderer.supplychain.com --tls --cafile $ORDERER_CA
...
#peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.supplychain.com --channelID $CHANNEL_NAME --name Supply-Chain --version 1.0 --collections-config ../Chaincode/collection-automobile.json --package-id $CC_PACKAGE_ID --sequence 1 --tls --cafile $ORDERER_CA --waitForEvent

peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.supplychain.com --channelID $CHANNEL_NAME --name Supply-Chain --version 1.0  --collections-config ../Chaincode/collection.json --package-id $CC_PACKAGE_ID --sequence 1 --tls --cafile $ORDERER_CA --waitForEvent
sleep 2

echo "—---------------Set up enviornment variable for LOGISTICS —-------------"
...
echo "—---------------Set up enviornment variable for DEPOT —-------------"
...
jq '.channel_group.groups.Application.groups.DepotMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.depot.supplychain.com","port": 7051}]},"version": "0"}}' config_copy.json > modified_config.json
...
echo "—---------------Set up enviornment variable for HQ —-------------"
...
jq '.channel_group.groups.Application.groups.HQMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.HQ.supplychain.com","port": 7051}]},"version": "0"}}' config_copy.json > modified_config.json
...
peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME --name Supply-Chain --version 1.0 --sequence 1 --collections-config ../Chaincode/collection.json --tls --cafile $ORDERER_CA --output json

#peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.supplychain.com --channelID $CHANNEL_NAME --name Supply-Chain --version 1.0 --sequence 1 --collections-config ../Chaincode/collection.json --tls --cafile $ORDERER_CA --peerAddresses localhost:7051 --tlsRootCertFiles $FACTORY_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $LOGISTICS_PEER_TLSROOTCERT --peerAddresses localhost:11051 $DEPOT_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $HQ_PEER_TLSROOTCERT
